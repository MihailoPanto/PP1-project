...
/** CUP v0.10k generated parser.
  * @version Wed Dec 20 15:46:35 CET 2023
  */
public class MJParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\022\000\002\003\007\000\002\002\004\000\002\004" +
    "\004\000\002\004\002\000\002\005\006\000\002\005\005" +
    "\000\002\006\005\000\002\006\003\000\002\010\005\000" +
    "\002\011\003\000\002\011\003\000\002\011\003\000\002" +
    "\007\005\000\002\007\003\000\002\012\004\000\002\013" +
    "\004\000\002\013\002\000\002\014\003" });
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\004\064\006\001\002\000\010\005\ufffe\032\ufffe" +
    "\064\ufffe\001\002\000\010\005\011\032\010\064\014\001" +
    "\002\000\004\064\014\001\002\000\004\006\026\001\002" +
    "\000\010\005\uffff\032\uffff\064\uffff\001\002\000\004\064" +
    "\017\001\002\000\004\064\ufff0\001\002\000\006\007\024" +
    "\012\023\001\002\000\006\007\ufff4\012\ufff4\001\002\000" +
    "\010\007\ufff1\012\ufff1\045\021\001\002\000\006\007\ufff3" +
    "\012\ufff3\001\002\000\004\047\022\001\002\000\006\007" +
    "\ufff2\012\ufff2\001\002\000\004\064\017\001\002\000\010" +
    "\005\ufffc\032\ufffc\064\ufffc\001\002\000\006\007\ufff5\012" +
    "\ufff5\001\002\000\004\002\001\001\002\000\004\064\032" +
    "\001\002\000\006\007\ufffa\012\ufffa\001\002\000\006\007" +
    "\041\012\040\001\002\000\004\016\033\001\002\000\010" +
    "\062\035\063\034\065\037\001\002\000\006\007\ufff8\012" +
    "\ufff8\001\002\000\006\007\ufff6\012\ufff6\001\002\000\006" +
    "\007\ufff9\012\ufff9\001\002\000\006\007\ufff7\012\ufff7\001" +
    "\002\000\004\064\032\001\002\000\010\005\ufffd\032\ufffd" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\041\000\004\003\003\001\001\000\002\001\001\000" +
    "\002\001\001\000\004\004\006\001\001\000\006\005\011" +
    "\014\012\001\001\000\004\014\026\001\001\000\002\001" +
    "\001\000\002\001\001\000\006\007\014\012\015\001\001" +
      ...
      switch (CUP$MJParser$act_num)
		...
		String I1 = (String)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new Type(I1); RESULT.setLine(I1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // OptionalSquareBrackets ::= 
            {
		 ...
		 RESULT=new NoOSBrackets(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // OptionalSquareBrackets ::= LSQBRACE RSQBRACE 
            {
              OptionalSquareBrackets RESULT = null;
		 RESULT=new OSBrackets(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // VarDeclaration ::= IDENT OptionalSquareBrackets 
            {
		...
		OptionalSquareBrackets O2 = (OptionalSquareBrackets)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new VarDeclaration(I1, O2); RESULT.setLine(I1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // VarDeclList ::= VarDeclaration 
            {
		...
		VarDeclaration V1 = (VarDeclaration)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new NoCommaVarDeclList(V1); RESULT.setLine(V1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // VarDeclList ::= VarDeclList COMMA VarDeclaration 
            {
              VarDeclList RESULT = null;
		...
		Integer N1 = (Integer)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new NumConst(N1); RESULT.setLine(N1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // ConstDeclaration ::= IDENT EQUAL ConstValue 
            {
		...
		ConstValue C2 = (ConstValue)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new ConstDeclaration(I1, C2); RESULT.setLine(I1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // ConstDeclList ::= ConstDeclaration 
            {
		...
		ConstDeclaration C1 = (ConstDeclaration)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new NoCommaConstDeclList(C1); RESULT.setLine(C1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // ConstDeclList ::= ConstDeclList COMMA ConstDeclaration 
            {
              ConstDeclList RESULT = null;
		...
		ConstDeclaration C2 = (ConstDeclaration)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new CommaConstDeclList(C1, C2); RESULT.setLine(C1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // ConstVarDecl ::= Type VarDeclList SEMI 
            {
		...
		VarDeclList V2 = (VarDeclList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).value;
		 RESULT=new VarDecl(T1, V2); RESULT.setLine(T1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // ConstVarDecl ::= CONST Type ConstDeclList SEMI 
            {
              ConstVarDecl RESULT = null;
		int T1left = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-2)).left;
		int T1right = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-2)).right;
		...
		ConstDeclList C2 = (ConstDeclList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).value;
		 ...
		 RESULT=new ConstVarDeclListDerived1(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // ConstVarDeclList ::= ConstVarDeclList ConstVarDecl 
            {
              ConstVarDeclList RESULT = null;
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 0: // Program ::= PROG IDENT ConstVarDeclList LBRACE RBRACE 
            {
              Program RESULT = null;
		...
		ConstVarDeclList C2 = (ConstVarDeclList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-2)).value;
