...
public class CommaVarDeclList extends VarDeclList {

    private VarDeclList VarDeclList;
    private VarDeclaration VarDeclaration;

    public CommaVarDeclList (VarDeclList VarDeclList, VarDeclaration VarDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CommaVarDeclList(\n");
