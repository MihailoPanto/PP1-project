...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(RelOp_Less_Equal RelOp_Less_Equal) { visit(); }
    public void visit(RelOp_Less RelOp_Less) { visit(); }
    public void visit(RelOp_Greater_Equal RelOp_Greater_Equal) { visit(); }
    public void visit(RelOp_Greater RelOp_Greater) { visit(); }
    public void visit(RelOp_Different RelOp_Different) { visit(); }
    public void visit(RelOp_EqualEqual RelOp_EqualEqual) { visit(); }
    public void visit(CondFactNoRelOp CondFactNoRelOp) { visit(); }
    public void visit(CondFactRelOp CondFactRelOp) { visit(); }
    public void visit(CondTermListNoAnd CondTermListNoAnd) { visit(); }
    public void visit(CondTermListAnd CondTermListAnd) { visit(); }
    public void visit(CondListNoOr CondListNoOr) { visit(); }
    public void visit(CondListOr CondListOr) { visit(); }
    public void visit(NoNsAccess NoNsAccess) { visit(); }
    public void visit(NsAccess NsAccess) { visit(); }
    public void visit(NoDesignatorExpr NoDesignatorExpr) { visit(); }
    ...
    public void visit(NoAddOpExprPart NoAddOpExprPart) { visit(); }
    public void visit(AddopExprPart AddopExprPart) { visit(); }
    ...
    public void visit(NoOptPrint NoOptPrint) { visit(); }
    public void visit(CommaOptPrint CommaOptPrint) { visit(); }
    public void visit(StmtPrint StmtPrint) { visit(); }
    public void visit(StmtRead StmtRead) { visit(); }
    public void visit(StmtError StmtError) { visit(); }
    public void visit(StmtDesignatorStatement StmtDesignatorStatement) { visit(); }
    ...
    public void visit(OptSquareBrackets OptSquareBrackets) { visit(); }
    public void visit(VDeclaration VDeclaration) { visit(); }
    public void visit(VArrayDeclaration VArrayDeclaration) { visit(); }
    public void visit(ErrorCommaVList ErrorCommaVList) { visit(); }
    public void visit(NoCommaVarDeclList NoCommaVarDeclList) { visit(); }
    public void visit(CommaVarDeclList CommaVarDeclList) { visit(); }
    public void visit(ErrorVarDecl ErrorVarDecl) { visit(); }
    public void visit(TypeSemiVarDecl TypeSemiVarDecl) { visit(); }
    ...
    public void visit(CommaConstDeclList CommaConstDeclList) { visit(); }
    public void visit(ConstDecl ConstDecl) { visit(); }
    public void visit(VarCVDeclaration VarCVDeclaration) { visit(); }
    public void visit(ConstCVDeclaration ConstCVDeclaration) { visit(); }
    public void visit(NoConstVarDeclarationList NoConstVarDeclarationList) { visit(); }
    public void visit(ConstVarDeclarationList ConstVarDeclarationList) { visit(); }
    public void visit(NoLocalVarDeclarationList NoLocalVarDeclarationList) { visit(); }
    public void visit(LocalVarDeclarationList LocalVarDeclarationList) { visit(); }
    public void visit(FormPar FormPar) { visit(); }
    public void visit(FPar FPar) { visit(); }
    public void visit(FPars FPars) { visit(); }
    public void visit(NoFormParsOptional NoFormParsOptional) { visit(); }
    public void visit(FormParsOptional FormParsOptional) { visit(); }
    public void visit(NoMethType NoMethType) { visit(); }
    public void visit(MethType MethType) { visit(); }
    public void visit(MTypeName MTypeName) { visit(); }
    ...
    public void visit(NoNameSpacesList NoNameSpacesList) { visit(); }
    public void visit(NameSpacesList NameSpacesList) { visit(); }
